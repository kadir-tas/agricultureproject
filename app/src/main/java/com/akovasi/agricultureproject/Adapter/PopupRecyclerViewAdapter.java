...
import com.akovasi.agricultureproject.FarmViewActivity;
...
public class PopupRecyclerViewAdapter extends RecyclerView.Adapter<PopupRecyclerViewAdapter.ViewHolder> {
    ...
    private FarmViewActivity.OnClickFarmName callback;

    LayoutInflater layoutInflater;

    public PopupRecyclerViewAdapter(Context context, ArrayList<String> farmNames, FarmViewActivity.OnClickFarmName callback) {
